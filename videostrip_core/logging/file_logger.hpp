...
// TODO: Promote filename as static member or constructor argument so we do not need to open/close
// file each time (time consuming) This would required some file opening/closing methods and
// validation
...
{
public:
    explicit FileLogger(const std::string& path) : ofs_(path, std::ios::app) {}
